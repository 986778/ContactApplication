...
let admin = User.newAdmin("Saurabh Tiwari","Male",22)
console.log(admin);
let user1 = admin.newUser("Sarvesh Tiwari","Male",21)
console.log(user1);
let createContact=user1.createContact("Satyam Tiwari","India")
console.log(createContact);
let updateContact=user1.updateContact(0,"contactName","Mamta")
console.log(updateContact);
let createContactInfo =user1.createContactInfo(0,8082728966,"2saurabh@gmail.com")
console.log(createContactInfo);
let updateContactInfo=user1.updateContactInfo(0,0,"phoneNumber",7685675990)
